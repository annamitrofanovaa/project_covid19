...
def hypothesis(df, city, what_to_do):
  ...
  y_sv = dataframe[dataframe['Дата'] == start_vaccination].iloc[0][what_to_do]
  print('показания "', what_to_do, '" с начала до начала вакцинации')
  t = (y_sv/y1)**(1/(dataframe.shape[0] - 1))*100
  print('средний темп прироста:')
  k1 = t - 100
  print(k1, '%')
  print('показания "', what_to_do, '" с начала вакцинации до конца')
